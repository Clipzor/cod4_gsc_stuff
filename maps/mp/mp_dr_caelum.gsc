...
end()
{
	...
	trig waittill("trigger",player);
	iPrintLnBold("^3"+player.name+" ^6reached the end!");
	ambientStop(1);
	thread end_counter();
	iPrintLn("^2Map by DeltaBoss");
	iPrintLn("^3sponsored by Universal Alliance!");
...
end_sniper_do(player)
{
	...
	wait 0.05;
	iPrintlnBold("^3" + player.name + " ^4picked a sniper fight!"); 
	wait 3;
...
end_deagle_do(player)
{
	...
	wait 0.05;
	iPrintlnBold("^3" + player.name + " ^4is a deagle bro!"); 
	wait 3;
	iPrintlnBold("^1 GET READY!");
	wait 1;
	iPrintlnBold("^1 3");
...
end_knife_do(player)
{
	...
	wait 0.05;
	iPrintlnBold("^3" + player.name + " ^4picked a knife fight!"); 
	wait 3;
...
end_islands_do(player)
{
	...
	wait 0.05;
	iPrintlnBold("^3" + player.name + " ^4is an island-jumper!"); 
	wait 3;
	iPrintlnBold("^1 GET READY!");
	wait 1;
	iPrintlnBold("^1 3");
