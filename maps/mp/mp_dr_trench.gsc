...
startdoor()
{
    ...
    wait 4;
    iPrintLnBold("^7Map Made By ^3VC'Fox & VC'Legend");
    door delete();
    iPrintLnBold("^5Map Has Started!");
}
...
secret_done()
{
    ...
    for(;;)
	{
        trig waittill("trigger", player);
        player setOrigin(tele1.origin);
        player freeze_thread(1);
        player setPlayerAngles(tele1.angles);
        player iPrintLnBold("^3You finished the Secret wowowowow");	
