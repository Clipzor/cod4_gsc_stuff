...
main() {
	...
	weapons()
	{
		...
		while( 1 )
		{
			...
			if ( weapon_pointer != 1 )
			{
				weapons SetHintString("Select Buttons: ^1Granade^7, ^1Shoot^7 -> Press ^1Knife");
				...
				weapname = strTok("TomaHawk;AK-47;AK74-U;M4;MP44;Winchester1200;M1014(grip);RPD;P90(silencer);DesertEagleGold;Skorpion;UZI(silencer);RPG",";");
				
				w = 1;			
				
				while ( weapon_pointer != 1 )
				{
			...
			/*/////////////////////////////////////////////////////////////////////////////////////*/
			weapons triggerOff();
			weapons SetHintString("Weapons room: ^1" + set_weapon);
			player freezeControls(true);
			player setorigin(jumper.origin);
			player setPlayerAngles(jumper.angles);
			activator freezeControls(true);
	...
	bounce()
	{
		...
		while(1)
		{
			...
			once_jumper_low = 0;
			knife_pointer = 0;
			while( knife_pointer != 1 && once_jumper_low != 1 )
			{
	...
	secret_music()
	{
		...
		if ( music_player == 0 )
		{
			...
			{
				music_pointer = 1;
				music = strTok("none;Music0;Music1;Music2;Music3;Music4;Music5;Music6;Music7",";");
				musicname = strTok("none;any;any1;any2;any3;any4;any5;any6;any7",";");
	...
	secret_weapon()
	{
		...
		while(1)
		{
			...
			else
			{
				...
				player iPrintLnBold("^1You got BAD luck!!!");
				wait 1;
				player iPrintLnBold("^1Sorry... you will die within 10 seconds...");
				wait 10;
				player suicide();
			}
	...
	end_trig()
	{
		...
		while(1)
		{
			...
			{
				player.end = 1;
				iPrintLnBold(player.name + " ^4reached the final door! ^3Congrat!");
			}
			wait .1;
		}
	}