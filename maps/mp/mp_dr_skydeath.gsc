...
teleport6()
{
	...
	while(1)
	{
		...
		iPrintlnBold( " ^6" + player.name + " ^3 FINISHED SECRET ^7WHAT A PRO JUMPER!^1!" );  
...
finalsniper()
{
	...
	if( isDefined( level.activ ) && isAlive( level.activ ) )		
        ...
        iPrintlnBold( " ^6" + player.name + " ^3 HAS ENTERED SNIPER^1!" );     //change to what you want it to be
        				ambientstop ( 1 );
ambientPlay("blue");
						player freezeControls(true);
						level.activ freezeControls(true);
...
finalold()
{
    ...
    while(1)
    {
        ...
        wait 0.05;
        iPrintlnBold( " ^6" + player.name + " ^3 HAS ENTERED OLD^1!" );     //change to what you want it to be
            wait 2;
...
finalrace()
{
    ...
    while(1)
    {
        ...
        wait 0.05;
        iPrintlnBold( " ^6" + player.name + " ^3 HAS ENTERED RACE^1!" );     //change to what you want it to be
