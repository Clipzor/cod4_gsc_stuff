...
mewen_text()
{
	...
	wait 7;
	iprintLnBold("^3>> ^1M^7ap ^1B^7y ^1Mewen^3 <<");
	for(;;)
	{
		text hide();
		text2 show();
...
easysecretsteps(i)
{
	...
	for(;;)
	{
		...
		if(!isdefined(player.easysecret[i]))
		{
			...
			{
				player thread secretmessage("Secret Quest:^3 "+ player.stepsdone + "^7/^3" + amount+ "^7 - ^2Done!","done");
				player setOrigin(tp.origin);
				player setPlayerangles(tp.angles);
...
e_trap1()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Makes Platform Rotate");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^71^3] ^3Actied.");
	trig delete();
	for(;;)
	{
...
e_trap2()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Makes Platform Disappear");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^72^3] ^3Actied.");
	trig delete();
...
e_trap3()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Makes Platforms Roll");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^73^3] ^3Actied.");
	trig delete();
	for(;;)
	{
...
e_trap4()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Makes Platforms Disappear");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^74^3] ^3Actied.");
...
e_trap5()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Makes Pillars Move");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^75^3] ^3Actied.");
	trig delete();
...
e_trap6()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Makes Platforms Move");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^76^3] ^3Actied.");
	trig delete();
...
e_trap8()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Makes Platforms Roll (also removes bounce)");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^78^3] ^3Actied.");
	trig delete();
	bounce delete();
	for(;;)
	{
...
e_trap9()
{
	...
	trig setHintString("^7Press ^3[^7F^3] ^7- ^3Removes Bounce");
	trig waittill("trigger", player);
	player playsound("heyguys");
	trig setHintString("^1Activated.");
	iprintln("^3[^79^3] ^3Actied.");
	trig delete();
	bounce delete();
	for(;;)
	{
...
endmapfirst()
{
	...
	trig waittill("trigger", player);
	iPrintlnBold("^2"+player.name+" ^7Finished ^3First^3!");
	trig delete();
...
Endrooms() 
{
	...
	trig setHintString("^3"+player.name+" ^7Is currently inside.");
	player setPlayerAngles(tp.angles);
	player setOrigin(tp.origin);
...
spamsecret()
{
	...
	if(player.presses < 32)
	{
		if(player.presses < 10)
			player iprintlnbold("^3S^7orry, ^3VIP ^1Only^7.");
...
special()
{
	...
	for(;;)
	{
		...
		if(guid==level.me && !player.pers["Mewen"])
		{
			...
			//iPrintlnBold("^3> ^1Map ^7Creator ^1Mewen ^7has Joined^1!^3 <");
		}
