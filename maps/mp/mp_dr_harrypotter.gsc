...
endroom_template(trigger, jumper_origin, acti_origin, weapon, weapon2, weapon_room, song_name)
{
    ...
    while(1)
    {
		...
		if(song_name == "songjump"){
			iPrintLn("^6Now Playing: ^3Harry Potter and the Chamber of Bangers ^1 - Mashd N Kutcher Mashup");
		}
		
		if(song_name == "songsnip"){
			iPrintLn("^6Now Playing: ^3Harry Potter - Expecto Patronum ^1 - Goblins From Mars Trap Remix");
		}
		
		if(song_name == "songknife"){
			iPrintLn("^6Now Playing: ^3Hedwig's Theme ^1 - The Future's Trap Remix");
		}
...
music()
{
	...
	if(possibility == 0)
	{
		iPrintLn("^6Now Playing: ^3The Arrival of Baby Harry");
		ambientPlay("song1");
	}
	
	if(possibility == 1)	
	{
		iPrintLn("^6Now Playing: ^3Buckbeak's Flight");
		ambientPlay("song2");
	}
	
	if(possibility == 2)	
	{
		iPrintLn("^6Now Playing: ^3Fireworks");
		ambientPlay("song3");
	}
	
	if(possibility == 3)		
	{
		iPrintLn("^6Now Playing: ^3Hedwig's Theme");
		ambientPlay("song4");
	}
	
	if(possibility == 4)	
	{
		iPrintLn("^6Now Playing: ^3Longbottom's Flight");
		ambientPlay("song5");	
	}
	
	if(possibility == 5)	
	{
		iPrintLn("^6Now Playing: ^3Opening");
		ambientPlay("song6");
	}
	
	if(possibility == 6)	
	{
		iPrintLn("^6Now Playing: ^3The Story Continues");
		ambientPlay("song7");			
	}
