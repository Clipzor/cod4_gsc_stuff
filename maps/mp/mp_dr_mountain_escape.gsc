...
{	
	...
	debris1 moveZ(-500,4);
	debris2 moveZ(500,4);
	iPrintlnBold( "^3Map made by ^2No0dle :D");
	iPrintln("^3Special Thanks to ^4Sux Lolz^3 for helping");
	iPrintln("^3Special Thanks to ^4ERICOS ^3for helping");
	iPrintLn("^3Moving shark script by ^4DarkFollower^3!!!");
	wait 4;
	debris1 delete();
	debris2 delete();
}
...
foundTreasure(){
	 ...
	 trig delete();
	 shark show();
	 iPrintLnBold("^4"+ player.name + " " + "I said ^1don't ^3open the treasue!");
	 player setPlayerAngles(gotoorigin.angles);
	 player FreezeControls(1);
	 wait 0.5;
	 iPrintLnBold("^1Oh no! ^2"+ player.name + " " + "^3is getting attacked by ^1shark!");
	 shark moveZ(170,1); 
	 wait 1;
...
bounceroom()
{
	...
	while(1)
	{
			...
			noti = SpawnStruct();
			noti.titleText = ("^3 "+player.name + " ^2Has Chosen Bounce Room!");
...
sniperroom() 
{
	 ...
	 while(1)
	 {
		...
		noti = SpawnStruct();
		noti.titleText = ("^4 "+player.name + "^3 Entered ^3Sniper room ^2Fight!");
		noti.notifyText = level.activ.name + " ^1VS^3 " + player.name;
		noti.duration = 6;
		noti.glowcolor = (0, 0, 1.0);
...
kniferoom() 
{
	...
	if( !isDefined( level.knifetrig ) )
	 ...
	 while(1)
	 {
		...
		noti = SpawnStruct();
		noti.titleText = ("^4 " + player.name + "^3 Entered ^3Knife room ^2Fight!");
...
oldroom()
{
	...
	noti = SpawnStruct();
	noti.titleText = ("^4" + player.name + "^3 has chosen ^3Old room!");
	noti.duration = 6;
	noti.glowcolor = (0, 0, 1.0);
...
songMenu()
{
	...
	self.hud_music[i] setText( "\n                 Press ^3[^71^3/^72^3/^73^3/^74^3/^75^3/^76^3/^77^3/^78^3]^7 To Play The Song." );
	...
	self.hud_music_s[j] setText("^21.^3Camila Cabello ^1-^7 Havana\n^22.^3Marshmello ^1-^7 Silence\n^23.^3Zedd ^1-^7 Stay\n^24.^3The CS & CP ^1-^7 Something just like this\n^25.^3MGK ^1-^7 Home\n^26.^3Era Istrefi ^1-^7 Bonbon\n^27.^3Major Lazer ^1-^7 Light it Up\n^28.^3NF ^1-^7 Let you down");
	...
	for(;;)
	{
		...
		if( menu == "music")
		{
			...
			{
				ambientPlay("song1");
				iprintln("^2Now Playing: ^3Camila Cabello ^1-^7 Havana");
			...
			{
				ambientPlay("song2");
				iprintln("^2Now Playing: ^3Marshmello ^1-^7 Silence");
				self freezeControls(0);
				self setClientDvar("song_picked",music);
				self notify("song_picked");
				break;
			...
			{
				ambientPlay("song3");
				iprintln("^2Now Playing: ^3Zedd ^1-^7 Stay");
				self freezeControls(0);
				self setClientDvar("song_picked",music);
				self notify("song_picked");
				break;
			...
			{
				ambientPlay("song4");
				iprintln("^2Now Playing: ^3The CS & CP ^1-^7 Something just like this");
				self freezeControls(0);
				self setClientDvar("song_picked",music);
				self notify("song_picked");
				break;
			...
			{
				ambientPlay("song5");
				iprintln("^2Now Playing: ^3MGK ^1-^7 Home");
				self freezeControls(0);
				self setClientDvar("song_picked",music);
				self notify("song_picked");
				break;
			...
			{
				ambientPlay("song6");
				iprintln("^2Now Playing: ^3Era Istrefi ^1-^7 Bonbon");
				self freezeControls(0);
				self setClientDvar("song_picked",music);
				self notify("song_picked");
				break;
			...
			{
				ambientPlay("song7");
				iprintln("^2Now Playing: ^3Major Lazer ^1-^7 Light it Up");
				self freezeControls(0);
				self setClientDvar("song_picked",music);
				self notify("song_picked");
				break;
			...
			{
				ambientPlay("song8");
				iprintln("^2Now Playing: ^3NF ^1-^7 Let you down");
				self freezeControls(0);
				self setClientDvar("song_picked",music);
				self notify("song_picked");
				break;
