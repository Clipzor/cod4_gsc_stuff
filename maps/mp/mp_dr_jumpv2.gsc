main() {
 ...
 trigger = getent("trig_endmap","targetname");
...
credits()
{
		...
		while(1)
        {
				self credit_roll( "I accept any donation >>> ^1Paypal : ^7MiThyXdeathrun@gmail.com", 3 );
				...
				self credit_roll( "^4---- ^2Map ^2by ^6M^2i^3T^4h^5y^6X ^4----", 5);
