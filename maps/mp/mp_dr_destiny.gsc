...
sad_moon()
{
	...
	player iPrintlnBold ( "^3You made ^2Mr.Moon ^3sad ^1:[ " );
	
	wait 2;
	
	player sayall( "^3OUCH^1!!!" );
...
shortcut()
{
	...
	iPrintlnBold( " ^2" + player.name + " ^3Found a Shortcut^1! " );         
}
...
lossy_iz_a_kent()
{
	...
	while(1)
	{
		...
		player giveMaxAmmo( "ak74u_mp" );
		iPrintlnBold( " ^2" + player.name + "^3 is Godlike^1!" );
		wait 0.05;
...
finalfight()
{
    ...
    while(1)
    {
        ...
        continue;
		iPrintln( "^3Final Fight Unlocked^1! " );
		brush movez( 304, 3.5);   
		ori movez( 304, 3.5);               
        break;
    }
...
bounceweap()
{
	...
	iPrintlnBold( " ^2" + player.name + " ^3Picked up the Minigun^1!" );
...
deagle()
{
	...
	while(1)
	{
		...
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Deagle Room^1!" );    
		wait 2;
		braxi\_common::cleanScreen();
		player iPrintlnBold( "^35" );
		level.activ iPrintlnBold( "^35" );
		wait 1;
		braxi\_common::cleanScreen();
		player iPrintlnBold( "^34" );
		level.activ iPrintlnBold( "^34" );
		wait 1;
		braxi\_common::cleanScreen();
		...
		wait 1;
		braxi\_common::cleanScreen();
		player iPrintlnBold( "^3Fight^1!" );
		level.activ iPrintlnBold( "^3Fight^1!" );
...
jump()
{
	...
	while(1)
	{
		...
		player freezecontrols(true); 
		level.activ freezecontrols(true);
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Jump Room^1!" );    
		wait 2;
		braxi\_common::cleanScreen();
		player iPrintlnBold( "^35" );
		level.activ iPrintlnBold( "^35" );
		...
		wait 1;
		braxi\_common::cleanScreen();
		player iPrintlnBold( "^3Jump^1!" );
		level.activ iPrintlnBold( "^3Jump^1!" );
		player freezecontrols(false); 
		level.activ freezecontrols(false);
		wait 2;
		braxi\_common::cleanScreen();
...
derpy()
{
	...
	while(1)
	{
		...
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Confusing Minigun Room^1!" );  
		wait 2;
		braxi\_common::cleanScreen();
		wait 1;
		player iPrintlnBold( "^33" );
...
snip()
{
	...
	while(1)
	{
		...
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Sniper Room^1!" );  
		wait 2;
		braxi\_common::cleanScreen();
		wait 1;
		player iPrintlnBold( "^33" );
...
classic()
{
	...
	iPrintlnBold( " ^2" + player.name + " ^3 has entered the Classic way^1!" );    
...
gravity()
{
	...
	while(1)
	{
		...
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Low Gravity Room^1!" );  
		wait 2;
		braxi\_common::cleanScreen();
		wait 1;
		player iPrintlnBold( "^33" );
...
b_beat()
{
	...
	trig setHintString( "^3Watcha doin^1' ^3in here^1?!?" );
...
knife()
{
	...
	while(1)
	{
        ...
        player switchToWeapon( "knife_mp" );
        level.activ SwitchToWeapon( "knife_mp" );
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Knife Room^1!" );  
		wait 2;
		braxi\_common::cleanScreen();
		wait 1;
		player iPrintlnBold( "^33" );
...
weapons()
{
	...
	while(1)
	{
		...
		player freezecontrols(true); 
		level.activ freezecontrols(true);
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Weapons Room^1!" );
		wait 2;
		braxi\_common::cleanScreen();
		wait 1;
		player iPrintlnBold( "^33" );
...
finalend_main() {
	...
	while(1)
	{
		...
		player freezecontrols(true); 
		level.activ freezecontrols(true);
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Final End^1!" );    
		wait 4;
		braxi\_common::cleanScreen();
		wait 14;
		player takeallweapons();
...
games()
{
		...
		origin delete();
	 	...
	 	iPrintlnBold( " ^2" + player.name + " ^3 has entered the endgames section^1!" );
        player TakeAllWeapons();
	 	player died();
		wait 1;
...
deagle_secret()
{
	...
	iPrintlnBold( " ^2" + player.name + " ^3 got dat sexy deagle^1!" );
...
died()
{
	...
	self waittill("death");
	iPrintlnBold("^2"+self.name+" ^3died^1!");
	iPrintlnBold("^3The Endgames Section is now open^1.");
	level.games_trig SetHintstring ("^3Endgames^1!");
}
...
door()
{
	...
	iPrintln("^3Detonation in^1: ^25");
	wait 1;
	iPrintln("^3Detonation in^1: ^24");
	wait 1;
	iPrintln("^3Detonation in^1: ^23");
	wait 1;
	iPrintln("^3Detonation in^1: ^22");
	wait 1;
	iPrintln("^3Detonation in^1: ^21");
	wait 1;
