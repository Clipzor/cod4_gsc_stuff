...
{
wait 7;
iprintln("^3>>^7eBc|Legend Welcomes you on mp_deathrun_crystal");
wait 17;
iprintln("^3>>^7Map Creator ^1eBc|Legend");
wait 21;
iprintln("^3>>^7Thanks For Playng Crystal");
wait 21;
iprintln("^3>>^7Have Fun and Enjoj the ^1C^2r^3y^4s^3t^6a^7l^8s");
wait 1;
}
...
{
wait(10);
thread drawInformation( 800, 0.8, 1, "^1C^2r^3y^4s^3t^6a^7l" );
wait(6);
...
{
dj_bord delete();
iprintln("^3>>^7Song: ^2Snoop ^0Dog^7 Smoke^2 Weed ^7Everyday");
iprintlnbold("^3" + user.name + " ^7Turns Music On!!");
ambientplay("weed");
wait 1;
}
}
...
oldroom()
{
    ...
    {   
		...
		level.activ iprintln("^3You'r Weapons Are Removed");
...
trigger = GetEnt( "finish", "targetname" );
	...
	trigger waittill ("trigger", user);
		{
		iprintlnbold( "^7" + user.name + " ^3F^7inished ^3F^7irst");
		wait 4;
		}
	}
}
