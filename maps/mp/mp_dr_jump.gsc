...
{
wait 10;
iprintlnBold("^4---- ^2Jump ^2by ^6M^2i^3T^4h^3y^6X ^4----");
wait 1;
}
...
{
wait 45;
iprintln("^4---- ^2Map ^2by ^6M^2i^3T^4h^3y^6X ^4----");
wait 1;
}
...
{
wait 20;
iprintln("^6Y^2o^3u^4t^3u^6b^2e^7:https://www.youtube.com/channel/UCLPUQ9wxNmnPcNcHxPkblrA");
wait 1;
}
...
{
wait 10;
iprintln("^2Special ^3Thanks: ^8[DJS]Deathrun, ^6Rmp, ^4Sux Lolz");
wait 1;
}
...
musicMenu() //Music Menu by Blades's. :]
{
	...
	while( self.sessionstate == "playing" )
	{
		...
		{
			iPrintln( "^3Now playing: ^7" + level.music[self.selection]["artist"]+" - ^2" +level.music[self.selection]["title"] );
...
musictrig()
{
	...
	trigger setHintString( "Press ^3[^7USE^3]^7to ^3Choose ^7Music" );
