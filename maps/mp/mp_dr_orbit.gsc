...
pressure_suit()
{
	...
	while(1)
	{
		...
		{
			player iPrintln("^3---You can only have one helmet at a time---");
		}
		...
		if(isDefined(player.hashelmet) && player.hashelmet == false)
		{
			...
			player iPrintln("^3---You picked up a helmet---");
...
map_tele1()
{
	...
	while(1)
    	{
        trig waittill ("trigger", player);   
		iPrintlnBold (" ^3" + player.name + " ^7 Entered the Meteoroid zone");
		player SetOrigin(end.origin);
        player SetPlayerAngles( end.angles );
...
trap5()
{
	...
	player braxi\_rank::giveRankXP("", 20);
	trigger SetHintString("^1Activated");
	iPrintlnBold("^3More meteoroids coming");
	trash5 show();
...
harddone()
{
        ...
        while(1)
        {
                ...
                if( player.pers["team"] == "allies" )
                {
						...
						player iprintlnBold ("^3"+player.name+" ^7finished the Planets!");
                ...
                else
                {
						...
						player iprintlnBold ("^3Activator ^7finished the Planets!");
						player.health = 100;
                }
        }
}
...
easydone()
{
        ...
        while(1)
        {
                ...
                if( player.pers["team"] == "allies" )
                {
						...
						player iprintlnBold ("^3"+player.name+" ^7finished the Broken station");
						player braxi\_rank::giveRankXP("", 100);
						player.health = 100;
                ...
                else
                {
						...
						player iprintlnBold ("^3Activator ^7finished the Broken station");
						player.health = 100;
                }
        }
}
...
creators()
{
	...
	wait 4;
	iPrintlnBold("^3Don't forget to grab helmets!");
	wait 2;
	while(1)
	{
		iprintln("^7Thanks to ^3VC'ERIK ^7and ^3VC'Fox ^7for the models!");
		wait 2;
		iprintln("^7Thanks to ^3VC'Legend^7, ^3VC'Phelix^7, ^3VC'Wingzor ^7and ^3SuX Lolz ^7for helping me with scripts!");
		wait 5;
		iprintln("^7Thanks to ^3Vistic Clan");
		wait 30;
		iprintln("^6steam: TheLixfe");
		wait 5;
		iprintln("^7Map by ^3TheLixfe");
		wait 10;
	}
}
//* By Blade
	...
	musictrig()
{
	...
	trig setHintString("Press [^3&&1^7] to choose Music");
