...
music()
{
  ...
  maps\mp\_fx::loopfx("effect_1", (secret.origin), 1);
  maps\mp\_fx::loopfx("effect_2", (acti1.origin), 1);
  maps\mp\_fx::loopfx("effect_3", (fire2.origin), 1);
  maps\mp\_fx::loopfx("effect_4", (fire1.origin), 1); //vhc
