...
if(!isdefined(level.music))
	...
	level.music[0]["song"]	="ROOFTOP PARTY – MICKEY SINGH";
	level.music[0]["alias"]	="party";
	level.music[1]["song"]	="Deep Money Feat. Bohemia";
	level.music[1]["alias"]	="deepmoney";
    level.music[2]["song"]	="SNIPER - Ekam Bawa Ft. Amrit Wadali";
	level.music[2]["alias"]	="sniper";
	level.music[3]["song"]	="AronChupa - I'm an Albatraoz";
	level.music[3]["alias"]	="albatraoz";
...
musicMenu()
{
	...
	self.hud_music[i] setText("^5Pak[i]stan");
...
wait 5;
iPrintlnBold("^5Made By ^0|^3P^0I^3K^0A^3[C]^0H^3U^0|");
iPrintlnBold("^2Pakistan Deahtrun");
iPrintlnBold("^5Special Thanks To Pro Master");
...
tele1door2 rotateyaw(-100, 4);
tele1door1 rotateyaw(100, 4);
}
shortcut()
{
...
trig setHintString("^5Press Use To Open The Door!");
trig waittill("trigger");
tele2door2 rotateyaw(-100, 4);
tele2door1 rotateyaw(100, 4);
}
...
trap6doorp2 rotateyaw(100, 2);
trap6door rotateyaw(100, 2);
}
actiteleport1()
{
...
level.knife_trigger delete();
level.sniper_trigger delete();
iprintln("Jaroslav Beck & Generdyn - Legend ft. Backchat");    
