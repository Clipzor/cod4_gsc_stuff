...
autofunc()
{
	...
	while(1)
	{
		...
		wait 4;
		iPrintLn("^3Visit: http://codscript.net/");
		wait 4;
...
trap1() //Works (Add Fx)
{
	...
	trigger sethintstring("^3>> ^3Trap Activated ^3<<");
...
triggeredplatform() 
{
	...
	trigger waittill("trigger");
	trigger setHintString("^3Platform Activated!");
...
mode()
{
	...
	trigger waittill("trigger");
	trigger sethintstring("^3>> ^3Hard Mode Activated ^3<<");
...
secret() //You must activate the secret in order to the teleportation system to work
{
	...
	level.secret_hud setText( ">>   ^2" + player.name + "^3 Has Unlocked The ^3Secret Room^6!   <<" );
...
actiruntext()
{
	...
	level.ar_hud setText( ">>   ^1" + player.name + "^3 Chosen ^3ActiRun!   <<" );
...
finished()
{
	...
	level.jump_hud setText( ">>   ^1" + player.name + "^3 Finished ^6Electory ^61ST!   <<" );
...
bouncetext()
{
	...
	level.bounce_hud setText( ">>   ^1" + player.name + "^3 Chosen ^3Bounce Room!   <<" );
...
gentext()
{
	...
	level.gen_hud setText( ">>   ^1" + player.name + "^3 Chosen ^3Generator Room!   <<" );
...
oldtext()
{
	...
	level.old_hud setText( ">>   ^1" + player.name + "^3 Chosen ^3Old Room!   <<" );
