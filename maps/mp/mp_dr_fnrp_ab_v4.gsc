...
{
wait 10;
iprintlnBold("^9Welcome To The ^3FNRP_ab_v4^1, ^3Map By #FNRP#ABprice");
wait 3;
...
bottomtext()
{
	...
	wait 10;
	iPrintLn("^3Map By ^3#FNRP#ABprice");
	wait 5;
	iPrintLn("^3Hope You Enjoy");
	wait 5;
	iPrintLn("^3Every Gap And Bounce Tested");
	wait 5;
	iPrintLn("^3Any Bug? Send Me Pm On FNRP Forms");
	wait 10;
	iPrintLn("^3There is ^11 ^3Secret on this map!");
	wait 10;
	iPrintLn("^6Custom Weapons And Player Models By VC' Fox");
	wait 10;
	iPrintLn("^6Thanks To ^3VC' Fox ^6For Helping Me");
	wait 10;
	iPrintLn("^6Thanks To ^3NitroFire ^6For Helping Me");
	wait 10;
	iPrintLn("^6Thanks To Testers ^3  #FNRP#Lucifer , #FNRP#kLeiN , #FNRP#XposeD , Cryptiic<3");
	wait 10;
...
npc()
{
	...
	iPrintlnBold( " ^3" + player.name + " ^3 pressed Secret Button!^9NPC Spawned" );
...
trap1()
{
	 ...
	 trig SetHintString("^2Press ^3[F] ^2To Activate");
     trig waittill("trigger", player);
...
trap4()
{
	...
	trig SetHintString("Press ^3[F] ^2To Activate");
	trig waittill("trigger", player);
...
{    
	 ...
	 for(;;)
	 {
		 ...
		 //<----------------------->\\
		 iPrintlnBold( " ^3" + player.name + " ^3 Finish The Secret!" );
	 }
}
...
{    
	 ...
	 for(;;)
	 {
         ...
         player freezeControls(0);
         player braxi\_rank::giveRankXP("", 333);
		 iPrintlnBold( " ^3" + player.name + " ^6 Finish The Acti Secret!" );
	 }
}
...
knife_room()
{
	...
	iPrintLnBold("^2 " + player.name + " ^3Entered The ^3knife ^3Room^2!");
	...
	wait 1;
	player iPrintLnBold("^3Kill That Activator^2!");
	level.activ iPrintLnBold("^3Kill That Jumper^2!");
...
sniper_room()
{
	...
	iPrintLnBold("^2 " + player.name + " ^3Entered The ^3Sniper ^3Room^2!");
	player.health = player.maxhealth;
	level.activ.health = level.activ.maxhealth;
	...
	level.activ iPrintLnBold("^21");
	wait 1;
	player iPrintLnBold("^3Shoot That Activator^2!");
	level.activ iPrintLnBold("^3Shoot That Jumper^2!");
...
shotgun_room()
{
	...
	iPrintLnBold("^2 " + player.name + " ^3Entered The ^3Shotgun ^3Room^2!");
	player.health = player.maxhealth;
	level.activ.health = level.activ.maxhealth;
...
rpg_room()
{
	...
	iPrintLnBold("^2 " + player.name + " ^3Entered The ^3Rpg ^3Room^2!");
	player.health = player.maxhealth;
	level.activ.health = level.activ.maxhealth;
	...
	level.activ iPrintLnBold("^21");
	wait 1;
	player iPrintLnBold("^3Blow That Activator^2!");
	level.activ iPrintLnBold("^3Blow That Jumper^2!");
