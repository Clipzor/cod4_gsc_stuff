...
laser()
{
	...
	killtrigger_laser1 enablelinkTo ();
	killtrigger_laser1 linkTo (laser1);
	laser1 moveZ(62, 1.5);
	laser1 waittill("movedone");
	killtrigger_laser2 enablelinkTo ();
	killtrigger_laser2 linkTo (laser2);
	laser2 moveZ(62, 1.5);
	laser1 moveZ(-62, 1.5);
	laser2 waittill("movedone");
	killtrigger_laser3 enablelinkTo ();
	killtrigger_laser3 linkTo (laser3);
	laser3 moveZ(62, 1.5);
	laser2 moveZ(-62, 1.5);
	laser1 moveZ(62, 1.5);
	laser3 waittill("movedone");
	killtrigger_laser4 enablelinkTo ();
	killtrigger_laser4 linkTo (laser4);
	laser4 moveZ(62, 1.5);
	laser3 moveZ(-62, 1.5);
	laser2 moveZ(62, 1.5);
	laser1 moveZ(-62, 1.5);
	laser4 waittill("movedone");
	killtrigger_laser5 enablelinkTo ();
	killtrigger_laser5 linkTo (laser5);
	laser5 moveZ(62, 1.5);
	laser4 moveZ(-62, 1.5);
	laser3 moveZ(62, 1.5);
	laser2 moveZ(-62, 1.5);
	laser1 moveZ(62, 1.5);
	laser5 waittill("movedone");
	killtrigger_laser6 enablelinkTo ();
	killtrigger_laser6 linkTo (laser6);
	laser6 moveZ(62, 1.5);
	laser5 moveZ(-62, 1.5);
	laser4 moveZ(62, 1.5);
	laser3 moveZ(-62, 1.5);
...
movingplatform1()
{
	...
	travel2 = getEnt ("travel2", "targetname");
