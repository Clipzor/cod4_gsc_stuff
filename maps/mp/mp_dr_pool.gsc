 main()
{
  ...
  addTriggerToList("trap1_aktiv");
  addTriggerToList("trap2_aktiv");
  addTriggerToList("trap3_aktiv");
  addTriggerToList("trap4_aktiv");
  addTriggerToList("trap5_aktiv");
  addTriggerToList("trap6_aktiv");
  addTriggerToList("trap7_aktiv");
  addTriggerToList("trap8_aktiv");
  addTriggerToList("trap9_aktiv");
  addTriggerToList("trap10_aktiv");
}
