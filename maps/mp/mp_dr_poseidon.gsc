...
#include braxi\_common;main() {if(getdvar("r_reflectionProbeGenerate")=="1")
...
iPrintlnBold("^3Map creator ^3"+player.name+" ^3Joined the game!");}}
onEndRound()
{while(1)
...
{players[i]GiveWeapon("deserteagle_mp");players[i]GiveMaxAmmo("deserteagle_mp");wait.05;players[i]SwitchToWeapon("deserteagle_mp");wait.05;iPrintlnBold("^3Map Maker ^3"+players[i].name+" ^3Joined the game!");self endon("disconnect");players[i]setperk("specialty_fastreload");}}}