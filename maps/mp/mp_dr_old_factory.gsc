...
maps\mp\_load::main();
	...
	level.music=[];
    level.music[0]["song"]    ="^5Fall Out Boy - Light Em Up";
    level.music[0]["alias"]    ="song_0";
	level.music[0]["length"]	=170;
    level.music[1]["song"]    ="^5Proximity - Loyal x Be Togheter";
    level.music[1]["alias"]    ="song_1";
	level.music[1]["length"]	=221;
    level.music[2]["song"]    ="^5Hardwell & KSHMR - Power (Remix)";
    level.music[2]["alias"]    ="song_2";
	level.music[2]["length"]	=187;
    level.music[3]["song"]    ="^5Green Day - Boulevard of Broken Dreams";
    level.music[3]["alias"]    ="song_3";
	level.music[3]["length"]	=222;
    level.music[4]["song"]    ="^5Yves V & Ilkay Sencan - Not So Bad";
    level.music[4]["alias"]    ="song_4";
	level.music[4]["length"]	=162;
    level.music[5]["song"]    ="^5Gotye - Somebody That I Used To Know";
    level.music[5]["alias"]    ="song_5";
	level.music[5]["length"]	=181;
...
weaponglassaa() //FULL CLIP WEAPON ROOM
{
...
activator_katana()
{
    ...
    while (1)
    {
        ...
        iPrintLnBold ("^5You^7 found the ^5Activator's Katana");
    }
}
...
jumptimerentrance() {
    ...
    while(1) {
        ...
        player iPrintLnBold ("^5You ^7entered the ^5Secret Way!");
    }
}
...
tpsecend() {
    ...
    for(;;)
    {
        ...
        player SetOrigin(target.origin);
        player SetPlayerAngles( target.angles );
        iPrintLnBold ("^5" + player.name + " ^7finished the ^5Secret Way!");
    }
}
...
trigger = getent ("gun_drop", "targetname");
    while(1) 
    {
		...
		{
			player iPrintlnBold("^5You^7 already got your ^5weapon");
		}
	}
}	
// VIP
...
hardsecretend_acti()
{
    ...
    for(;;)
    {
        ...
        player thread removeTextActivator();
        player iPrintLnBold ("^5You ^7finished the ^5Activator Secret Way!");
