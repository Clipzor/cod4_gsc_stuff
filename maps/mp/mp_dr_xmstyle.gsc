...
startdoor()
{
		...
		iPrintLnBold("^7Welcome to ^3#XM Style!!");
		wait 5;
...
while(1)
{
	...
	trig waittill("trigger", player);
	trig setHintString("Press [USE] to Enter xM Vault");
	if(player getGuid() == "2310346615434407089" /*Fox*/ || player getGuid() == "2310346615138714709") 
{
	player.vip = true;
...
vip_leave()
{
	...
	trig setHintString("Press [USE] to Leave xM Vault");
...
xp_secret()
{
	...
	tele = getEnt("trig_sniper", "targetname");
	player iPrintLnBold("teled to end");
