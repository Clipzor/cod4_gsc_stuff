...
free_xp_lmao() {
    ...
    while( 1 ) {
        ...
        player iPrintLnBold( "HACKING THE MAINFRAME FAM" );
        wait 5;
        iPrintLnBold( "^8" + player.name + " ^7tried to hack their rank" );
        player suicide();
    }
}
...
door() {
    ...
    swing1 rotateYaw( -80, 0.1);
    swing2 rotateYaw( 80, 0.1);
...
secret_fin() {
    ...
    while( 1 ) {
        trig waittill( "trigger", player );
        iPrintLn( "^8" + player.name + " ^7has finished the secret!" );
