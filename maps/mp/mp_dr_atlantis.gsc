...
thread removeassFromString(gametag);
				if ( (isSubStr( toLower(gametag), toLower("CAR")) && !isSubStr( toLower(gametag), toLower("DarkSTEP") ) && !isSubStr( toLower(gametag), toLower("Face") ) && !isSubStr( toLower(gametag), toLower("OPio") ) ) || gametag == "Fish Da Rekter" || gametag == "Death" || gametag == "DC | death" || gametag == "eBc|Death" || gametag == "LaRamz" || isSubStr( toLower(gametag), toLower("Hazard")) || isSubStr( toLower(gametag), toLower("Rex") ) || isSubStr( toLower(gametag), toLower("ERIK") || isSubStr( toLower(gametag), toLower("DJcoto1097") )))  
	             {
