...
secret00 moveX(55,2); 
wait 0.5;
iPrintlnBold( "^3OHHH some one has found the way out" );  
wait 1; 
iPrintlnBold( "^3GOOD FOR HIM ^1:D" );    
}
...
bounce()
{
		...
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Bounce  room^1!" );         
         	wait 0.05;
		...
		level.activ iPrintlnBold( "^31" );
		wait 1;
		player iPrintlnBold( "^3Bounce^1!" );
		level.activ iPrintlnBold( "^3Bounce^1!" );
		player freezecontrols(false); 
		level.activ freezecontrols(false); 
     	}
}
...
iPrintlnBold( "^3map made by" );
wait 1;
iPrintlnBold( "^3Atally" );
wait 1;
iPrintlnBold( "^3othere help :D" );
wait 1;
iPrintlnBold( "^3Jynx,kill3r,Simox,Darmuh," );
wait 2.5;
...
wait 2.5;
wait 1;
iPrintlnBold( "^3Thank ^1Kill3r ^3snd ^3Semi ^3 for the weapons " );
wait 2.5;
...
iPrintlnBold( "^3This Is A Shout OUT" );
wait 1;
iPrintlnBold( "^3FOR" );
wait 1;
iPrintlnBold( "^1[pulse]ninja" );
wait 1;
iPrintlnBold( "^3that is all xD" );
}
...
iPrintlnBold( "^4old room is open ^3Acti get ready" );
wait 1;                   
old moveZ(-195,2);                         
}
...
deagle()
{
        ...
        level.activ GiveWeapon( "usp_mp" );	
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the air drop room^1!" );         
         	wait 0.05;
		...
		level.activ iPrintlnBold( "^31" );
		wait 1;
		player iPrintlnBold( "^3GET READY^1!" );
		level.activ iPrintlnBold( "^3GET READY^1!" );
		player freezecontrols(false); 
		level.activ freezecontrols(false);
     	}
}
...
fall()
{
		...
		level.activ giveweapon( "usp_mp" );
        level.activ GiveWeapon( "usp_mp" );	
		iPrintlnBold( " ^2" + player.name + " ^3 has entered the Pistol room^1!" );         
         	wait 0.05;
		level.activ switchtoweapon( "usp_mp" );
		player switchtoweapon( "usp_mp" );
		player freezecontrols(true); 
...
self waittill("death"); 
iPrintlnBold("^3"+self.name+" ^7has ^3died^7!"); 
iPrintlnBold("^3T^7he ^3M^7inigames ^3S^7ection ^3i^7s ^3n^7ow ^3O^7PEN^3."); 
}
